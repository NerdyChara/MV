...
(function ($) {
        ...
        if (Utils.isNwjs() && isValid) {
            try {
                ...
                fontList.forEach(async fontFile => {
                    ...
                    console.log(fontFile.substr(fontFile.lastIndexOf("/") + 1));
                    // FontManager.load(fontFamily, );
                });
    ...
    const alias_Scene_Boot_loadGameFonts = Scene_Boot.prototype.loadGameFonts;
    Scene_Boot.prototype.loadGameFonts = function() {
        alias_Scene_Boot_loadGameFonts.call(this);
        $.loadFonts();
    };
